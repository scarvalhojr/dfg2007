...
them, BLAST, without any lost of sensitivity.
...
different experiments. In collaboration with the chair of Genetics in Bielefeld, we
...
The suffix arrays mentioned above find also here an application.
...
In this phase a post-doctoral researcher will lead the design of the necessary
...
lead by a post-doctoral researcher. An initial working implementation providing
...
post-doctoral researchers (with the other programmer working independently on
...
single programmer under the supervision of both post-doctoral researchers, and
...
of the results will be under the responsibility of both post-doctoral researchers, with
...
\begin{itemize}
\item 1 post-doctoral researcher (wiss.\ Mitarbeiter E14)
...
A number of Ph.D.\ students will in the next years graduate
...
%% Begin ignore block
\ignore{
Dr.\ Veli Mäkinen, University of Helsinki:
...
Prof.\ Stefan Kurtz, University of Hamburg und
Prof.\ Robert Giegerich, Bielefeld University:
