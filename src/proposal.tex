...
{\bf Dual Sparse De-Bruijn Subgraphs (DSDS)}\\[5ex]
Prof.\ Dr.\ Jens Stoye\\
...
Milestones: A) understanding the graph; B) Applications.
...
Im folgenden sind die beantragten Mittel für den Antragszeitraum von 30 Monaten
aufgeführt.
...
\textbf{Summary (Zusammenfassung):}\hfill\begin{tabular}[t]{lrl}
\nth{1} Year (1. Jahr) & 12 Months (Monate) & wiss.\ MA BAT Ib \\
                       & 12 Monate (Monate) & stud.\ HK, 19 h/Woche\\
\nth{2} Year (2. Jahr) & 12 Monate (Monate) & wiss.\ MA BAT Ib \\
                       & 12 Monate (Monate) & stud.\ HK, 19 h/Woche
\end{tabular}
...
\textbf{Zusammenfassung (Summary):}\hfill\begin{tabular}[t]{lr}
...
{\bf TODO Sergio: translate}

{\bf TODO Jens: update}

The Research Group Genome Informatics was founded in March 2002, with financial
support from the DFG-Initiative ``Bioinformatics'', being today one of the
...
Applicant has existing cooperations on index-based sequence analysis with
StefanKurtz, Giegerich, Myers (CS coops). Bio coops: Weißhar.

It is planned to cooperate with Felipe Rodrigues da Silva (ask to provide
letter).
