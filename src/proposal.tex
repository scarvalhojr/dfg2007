...
Weiterverarbeitung der genomischen Information. Das Zentrum für
...
nehmen, mit einer theoretischen Kapazität von stündlich mehreren
Millionen DNA-Basenpaaren. Die große Herausforderung beim Einsatz
...
Using our current implementation of Sparse De-Bruijn Subgraphs, 32 GB of memory
...
current requirements and, hence, a machine with 16 GB of memory should suffice.

The Genome Informatics research group has aquired in early 2003 a computer
server with 96 GB of memory, which is now part of the infrastructure provided by
the Bioinformatics Resource Facility of the CeBiTec. Although this machine has
enough memory for running applications based on DSDS, it will be five years old
by the time the project proposed here starts. Therefore, we request funds for
acquiring a new computer server.

{\bf TODO: describe machine requested, update costs below}
...
{\bf TODO: mention that a new server will be bought?}
